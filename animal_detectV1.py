...
import numpy as np
import os
from package.msg import animal_detection_info
from package.msg import animal_detection_cmd
...
def sub_callback(cmd_msg):
    if cmd_msg.OpenCmd == 1:
        data_buffer.clear()
        detect()
        for it in data_buffer:
            publish(it['category'], it['PX'], it['PY'])
